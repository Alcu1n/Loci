...
enum LociError: LocalizedError { case unavailableConfiguration, invalidCoordinates, outputTooLarge, noResults, renderFailed, previewUnavailable, locationDenied, locationUnavailable, locationTimedOut
